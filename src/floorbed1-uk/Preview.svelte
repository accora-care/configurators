...
<PreviewFrame>
  ...
  {/if}
  {#if "High with Slide Sheets" === $configStore.safetyMat}
    <Img src={`/images/floorbed1-uk/1200/safetyMat.png`} />
  {/if}
</PreviewFrame>
